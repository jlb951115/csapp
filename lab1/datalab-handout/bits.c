...
int isAsciiDigit(int x) {
  return !(((x+0x06)&~0x0F)^0x30)&!!((x&0xF0)^0x20);
}
/* 
...
int isLessOrEqual(int x, int y) {
	return ((!((x>>31)^~0)&!(y>>31))|!((y+~x+1)>>31))&!(!(x>>31)&!((y>>31)^~0)); 
}
//4
/* 
...
int floatFloat2Int(unsigned uf) {
	...
	if (shift < 0 )
		...
		return ((frac>>(23-shift)) + (1<<shift))|(sign>>(30-shift));	else
		return ((frac<<(shift-23)) + (1<<shift))|(sign>>(30-shift));
}
/* 
